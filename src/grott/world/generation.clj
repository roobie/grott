(ns grott.world.generation
  (:use [clojure.set :only (union difference)]
        [grott.entities.player :only [make-player]]
        [grott.entities.lichen :only [make-lichen]]
        [grott.entities.bunny :only [make-bunny]]
        [grott.entities.silverfish :only [make-silverfish]]
        [grott.world.core :only [tiles get-tile-from-tiles random-coordinate
